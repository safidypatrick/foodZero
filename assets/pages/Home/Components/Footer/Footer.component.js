        ...
        <div className="footer-page">
            <div className="footer-wrapper">
                ...
                <div className="footer-desktop">
                    ...
                    <div className="footer-menu">
                        ...
                        <div className="menu-item">Pricing</div>
                            <NavLink to="/produits" className="menu-item"> Products </NavLink>
                            <NavLink to="/commandes" className="menu-item"> Contact </NavLink>
                    </div>

                    <div className="other-menu">
                        <div className="other-item">Careers</div>
                        <div className="other-item">Community</div>
                        <div className="other-item">Privacy Policy</div>
                    </div>

                    <div className="bloc-wrapper">
                        <div className="button-bloc">
                            <div className="input-update">
                                <input type="text" className="input-box" placeholder='Updates in your inbox...'/>
                            </div>
                            <div className="go-button">Go</div>
                        </div>
                    <div className="text-copyright">Copyright 2021. All Rights Reserved</div>
                    </div> 
                </div>
                ...
                <div className="footer-mobile">
                    ...
                    <div className="text-copyright">Copyright 2022. All Rights Reserved</div>
                </div>
            </div>
        </div>
    )
