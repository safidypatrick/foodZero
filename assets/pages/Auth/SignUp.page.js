                ...
                <div className="px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div className="mt-5">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="mt-8">
                                <div className="text-xs font-bold text-gray-700 tracking-wide">Votre Nom</div>
                                <input
                            ...
                            <div className="mt-8">
                                <div className="text-xs font-bold text-gray-700 tracking-wide">Votre Pseudo</div>
                                <input
                                    className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                    type=""
                                    placeholder="Pseudo"
                        ...
                        <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                J'ai déjà un compte. &nbsp;
                            <NavLink to="/" className="cursor-pointer text-indigo-600 hover:text-indigo-800">
                                Se connecter
                            </NavLink>
                        </div>
                    </div>
